...
<div>
    <button onClick={()=>(setCount1((c)=>c+1), setCount2((c)=>c-1))} className="abc" style={{fontSize:20}}> Like 👍 {calc}</button>
    <button onClick={()=>(setCount2((c)=>c+1), setCount1((c)=>c-1))} className="abc" style={{fontSize:20}}> Dislike 👎 {calc2} </button>
